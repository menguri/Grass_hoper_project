...
def Period_VolumeData(corporation, num, driver, week, dates):
    # 기업 바뀔 때마다 새로고침
    # if num == 0 :
    #     driver.refresh()
    ...
    sleep(2)
    # 이전 창 삭제
    WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, '/html/body/div[2]/section[2]/section/ul/li[1]/a/button'))).click()
    # fin
    dic = {
        'Price': Price,
        'Count': Count,
